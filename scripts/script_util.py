...
from unet.teacher_unet import SuperResModel, UNetModel, EncoderUNetModel
from unet.student_unet import ShiftUNet, MLPSkipNet, Base_model
...
def create_semantic_net(
    ...
    return Base_model(semantic_encoder, gradient_predictor)

def create_denoise_fn(
